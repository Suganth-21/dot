...
PERMISSION_MATRIX: dict[str, frozenset[Role]] = {
    ...
    "facility_runs:read": frozenset({Role.DISTRIBUTOR, Role.PICKUP_AGENT, Role.MANUFACTURER, Role.REGULATOR}),
    "facility_runs:create_or_dispatch": frozenset({Role.DISTRIBUTOR}),
    "facility_runs:deliver": frozenset({Role.PICKUP_AGENT}),
